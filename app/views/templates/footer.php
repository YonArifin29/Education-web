      <?php
        if($data["halamanSebelumnya"] OR $data["halamanSelanjutnya"]) {
            include("tombolHalaman.php");
        }
      ?>
    ...
    <footer class="main-footer text-center">
        <strong>Copyright &copy; 2023 <a href="<?=BASEURL;?>">Yon Arifin</a></strong>
...
<script src="<?=BASEURL?>/js/cropper.js"></script>
