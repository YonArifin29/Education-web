...
<body>
    <nav>
        <div class="nav-judul"><h1>UPSKILLING</h1></div>
        ...
        <div class="nav-right-items">
            <ul>
                <li><a href="<?=BASEURL?>/Login"><button>Login</button></a></li>
            </ul>
        </div>
    </nav>
    <section class="hero">
        <div class="hero-left-side">
            ...
            <div class="content">
                <p>Tingkatkan keahlian mu bersama kami untuk masa depan yang lebih cerah. Temukan keahlian yang kamu sukai dan tingkatkan keahlian mu bersama kami! </p>
            </div>
            <div class="button">
                <a href="<?=BASEURL?>/Registrasi"><button>Daftar Sekarang -></button></a>
            </div>
        </div>
        <div class="hero-right-side">
                <img src="img/pana1.png" alt="">
        </div>
    </section>
    <section class="layanan">
        <div class="leftside">
            <div class="judul">
                <p>Mengapa harus memilih <span>Upskilling?</span></p>
            </div>
            <div class="konten">
                <p>Daftarkan diri kamu dan dapatkan semua keuntungannya!</p>
            </div>
        </div>
        <div class="rightside">
            <ul>
                <li>
                    <div class="container">
                        ...
                        <div class="content">
                            <div class="title">Akses ke semua pembelajaran</div>
                            <div class="text">Pilih pembelajaran yang cocok dengan keahlianmu, kamu juga bisa mendapatkan keahlian baru!</div>
                        </div>
                    </div>
                </li>      
                <li>
                    <div class="container">
                        <img src="img/edu.png" alt="">
                        <div class="content">
                            <div class="title">Belajar dimana saja</div>
                            <div class="text">Belajar apa saja, dan dimana saja sesuai keinginanmu!</div>
                        </div>
                    </div>
                </li>      
                <li>
                    <div class="container">
                        <img src="img/edu.png" alt="">
                        <div class="content">
                            <div class="title">Pengajar ahli di bidangnya</div>
                            <div class="text">Tutor langsung dari ahlinya dengan standard industri!</div>
                        </div>
                    </div>
                </li>      
            </ul>
